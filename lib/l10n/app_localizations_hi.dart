...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get reviewSubtitleBillPayment =>
      'मैं एक **सोलो डेवलपर** हूं जो आपकी संपत्तियों के प्रबंधन को आसान बनाने के लिए **दिन-रात** काम कर रहा हूं।\n\nअगर RentKhata ने आज आपके 5 मिनट बचाए हैं, तो **5-स्टार रिव्यू** देना सबसे अच्छा तरीका है जिससे आप मुझे सपोर्ट कर सकते हैं!';
  ...
  @override
  String get meterPhotoAdded => 'सफलतापूर्वक जोड़ दिया गया';
  ...
  String get phonePdfExplanation =>
      'किरायेदारों को आपसे आसानी से संपर्क करने में मदद करने के लिए आपका फ़ोन नंबर पीडीएफ चालान पर प्रदर्शित किया जाएगा।';
