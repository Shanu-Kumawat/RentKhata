...
@riverpod
Stream<List<Property>> propertiesStream(Ref ref) {
...
@riverpod
Stream<List<Room>> roomsForPropertyStream(Ref ref, int propertyId) {
  final repo = ref.watch(propertyRepositoryProvider);
...
@riverpod
Future<List<Room>> roomsForProperty(Ref ref, int propertyId) {
  final repo = ref.watch(propertyRepositoryProvider);
...
/// Get all rooms.
@riverpod
Future<List<Room>> allRooms(Ref ref) {
  final repo = ref.watch(propertyRepositoryProvider);
