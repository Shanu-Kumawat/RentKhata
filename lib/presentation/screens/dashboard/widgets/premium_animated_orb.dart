    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // The Icon Itself
          Icon(icon, size: size * 0.3, color: primaryColor)
              .animate(onPlay: (controller) => controller.repeat(reverse: true))
              .slideY(
                begin: -0.05,
                end: 0.05,
...
class _AnimatedBlob extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        .rotate(
          begin: reverse ? 0.05 : -0.05,
          end: reverse ? -0.05 : 0.05,
          duration: duration,
          curve: Curves.easeInOut,
        );
  }
...
class _OrbitingParticleState extends State<_OrbitingParticle>
